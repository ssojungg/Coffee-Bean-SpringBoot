...
public class MemberController {
    ...
    public String create(@Valid MemberForm form, BindingResult result) { //여기도 BindingResult result 추가함

        if(result.hasErrors()) {
            return "members/createMemberForm"; //이거 해줘서 아무것도 안쓰면 회원 이름 필수라고 뜸
        }
